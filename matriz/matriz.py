...
def getSequences(matriz, l_sequence):
    ...
    Get a sequence
    >>> getSequences([[2, 1, 5, 5, 3], [2, 2, 5, 5, 3], [3, 3, 1, 2, 2], [5, 4, 4, 1, 2]], 4) # doctest: +NORMALIZE_WHITESPACE, +ELLIPSIS
    <BLANKLINE>
    ...[((0, 1), (4, 1))]

    Do not get a sequence
    >>> getSequences([[2, 2, 5, 5, 3], [2, 2, 5, 5, 3], [3, 3, 1, 2, 2], [5, 4, 4, 1, 2]], 4) # doctest: +NORMALIZE_WHITESPACE, +ELLIPSIS
    <BLANKLINE>
    ...[]
    """
    result = []
